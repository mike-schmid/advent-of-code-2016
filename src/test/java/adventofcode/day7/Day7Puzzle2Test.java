...
public class Day7Puzzle2Test {
    ...
    public void isIpv7_1() throws Exception {
        Assert.assertTrue(Day7Puzzle2.isSslSupported("aba[bab]xyz"));
    }

    @Test
    public void isIpv7_2() throws Exception {
        Assert.assertFalse(Day7Puzzle2.isSslSupported("xyx[xyx]xyx"));
    }

    @Test
    public void isIpv7_3() throws Exception {
        Assert.assertTrue(Day7Puzzle2.isSslSupported("zazbz[bzb]cdb"));
    }

    @Test
    public void isIpv7_4() throws Exception {
        Assert.assertTrue(Day7Puzzle2.isSslSupported("aaa[kek]eke"));
    }

    @Test
    public void isIpv7_5() throws Exception {
        Assert.assertTrue(Day7Puzzle2.isSslSupported("ioxsdfxoj[asfduaukgjhsdl]qweauartzabbauiop[hgdfgh]zxcvbnioxsdxoj"));
    }
    ...
    public void solveReal() throws Exception {
        ...
        Assert.assertEquals(242, Day7Puzzle2.solve(input));
