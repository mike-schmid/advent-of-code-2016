 ...
 * @author Mike Schmid
 */
public class Day7PuzzleTest {

    @Test
    public void isIpv7_1() throws Exception {
        Assert.assertTrue(Day7Puzzle.isTlsSupported("abba[mnop]qrst"));
    }

    @Test
    public void isIpv7_2() throws Exception {
        Assert.assertFalse(Day7Puzzle.isTlsSupported("abcd[bddb]xyyx"));
    }

    @Test
    public void isIpv7_3() throws Exception {
        Assert.assertFalse(Day7Puzzle.isTlsSupported("aaaa[qwer]tyui"));
    }

    @Test
    public void isIpv7_4() throws Exception {
        Assert.assertTrue(Day7Puzzle.isTlsSupported("ioxxoj[asdfgh]zxcvbn"));
    }

    @Test
    public void isIpv7_5() throws Exception {
        Assert.assertTrue(Day7Puzzle.isTlsSupported("ioxsdfxoj[asfdkgjhsdl]qwertzabbauiop[hgdfgh]zxcvbnioxsdxoj"));
    }

    @Test
    public void isIpv7_6() throws Exception {
        Assert.assertFalse(Day7Puzzle.isTlsSupported("ioxxoj[asfdkgjabdbahsdl]fguhlskdfhglskdf[habbagdfgh]zxcvbn"));
    }

    @Test
    public void solveReal() throws Exception {
        final List<String> input = Arrays.asList("rhamaeovmbheijj[hkwbkqzlcscwjkyjulk]ajsxfuemamuqcjccbc\n" ,
        ...
        Assert.assertEquals(110, Day7Puzzle.solve(input));
