...
public class Day02Puzzle2Test {
    ...
    public void solve() throws Exception {
        ...
        final String input = "5\t9\t2\t8\n" +
                "9\t4\t7\t3\n" +
                "3\t8\t6\t5";

        Assertions.assertEquals(9, Day02Puzzle2.solve(input));
    ...
    public void solveReal() throws Exception {
        ...
        final String input = "515\t912\t619\t2043\t96\t93\t2242\t1385\t2110\t860\t2255\t621\t1480\t118\t1230\t99\n" +
        ...
        Assertions.assertEquals(326, Day02Puzzle2.solve(input));
