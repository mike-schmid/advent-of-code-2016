...
public class Day04Puzzle2Test {
    ...
    public void solve() throws Exception {
        final String testInput = "aaaaa-bbb-z-y-x-123[abxyz]\n" +
                "a-b-c-d-e-f-g-h-987[abcde]\n" +
                "not-a-real-room-404[oarel]\n" +
                "totally-real-room-200[decoy]\n";

        Assertions.assertEquals(0, Day04Puzzle2.solve(testInput));
    }

    @Test
    public void solveReal() throws Exception {
        final String testInput = "bkwzkqsxq-tovvilokx-nozvyiwoxd-172[fstek]\n" +
        ...
        Assertions.assertEquals(984, Day04Puzzle2.solve(testInput));
    }
